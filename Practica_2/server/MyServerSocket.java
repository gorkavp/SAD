...
public class MyServerSocket extends ServerSocket {
    ...
    public void text_console() throws IOException { // Read what is written in the console to send it
    ...
    public void text_client_to_server(String username) throws IOException { // Read the messages from the clients
