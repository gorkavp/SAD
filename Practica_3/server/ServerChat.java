...
public class ServerChat implements ActionListener {
    ...
    // Method to listen the events of the JTextField and the JButton and send the
    // message
    public void actionPerformed(ActionEvent event) {

        Server.content.put("key", content.getText());
    ...
    private static void createAndShowGUI() throws Exception {
        ...
        // Set the look and feel of the GUI to the system look and feel
        UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
        // Set the JFrame decorated with the system look and feel
        JFrame.setDefaultLookAndFeelDecorated(true);
        // Launch a new ServerChat
        new ServerChat();
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Launch a new Server with the port number passed as argument
            new Server(messages, users_list).ServerLauncher(Integer.parseInt(args[0]));
